...
import models.modules.multiregression_arch as multiregression
...
def define_G(opt):
    ...
    if which_model == 'multiregression':
        netG = multiregression.multiregression(in_nc=opt_net['in_nc'], out_nc=opt_net['out_nc'],
